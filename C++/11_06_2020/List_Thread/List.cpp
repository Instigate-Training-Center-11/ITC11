...
namespace Data {
    ...
    /* Thread - insert */
    void LinkedList::insertThread(int value, int number) {
        std::thread thread(&LinkedList::insertElement, this, value, number);
    ...
    /* Thread - remove */
    void LinkedList::removeThread(int number) {
        std::thread thread(&LinkedList::removeElement, this, number);
