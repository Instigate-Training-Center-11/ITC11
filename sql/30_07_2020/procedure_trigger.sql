...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger t after update on order_list for each row begin if orders.isbool = 1 then update orders set orders.time = NOW() where orders.order_id = nlist.order_id; end if; end */;;
DELIMITER ;
...
INSERT INTO `orders` VALUES (1,1,24,'00:20:20',0),(2,1,50,'15:30:00',0),(3,2,30,'18:00:00',0);
...
INSERT INTO `product` VALUES (2,1,10,100,1000,'1 mounth','product_name'),(3,1,25,200,250,'2 mounth','apple'),(4,3,250,5000,100,'2 mounth','orange');
...
-- Dump completed on 2020-07-31 14:14:26
